...
while d < numfolds:
    ...
    while a < numimgs:
        ...
        if abs(maxtime - time) <= abs(time - mintime):
            timeclose2 = maxtime
        else:
            timeclose2 = mintime   
                
        
        locclose = time1.index(timeclose2)
